...
public final class ExpansionTextConstants {
	...
	public static final ResourceLocation GUI_COLLECTOR_1 = PECore.rl("textures/gui/collector1.png");
	/** Background of the collector screen, the "mk2" variant. */
	public static final ResourceLocation GUI_COLLECTOR_2 = PECore.rl("textures/gui/collector2.png");
	/** Background of the collector screen, the "mk3" variant. */
	public static final ResourceLocation GUI_COLLECTOR_3 = PECore.rl("textures/gui/collector3.png");
	/** Arrow pointing into an emc link, the import side. */
	public static final ResourceLocation GUI_EMC_IMPORT = PECore.rl("textures/gui/emc_import.png");
	/** Arrow pointing out of an emc link, the export side. */
	public static final ResourceLocation GUI_EMC_EXPORT = PECore.rl("textures/gui/emc_export.png");
	/** Input slot overlay of the MK3 condenser. */
	public static final ResourceLocation GUI_CONDENSER_MK3_INPUT = PECore.rl("textures/gui/condenser_mk3_input.png");
	/** Output slot overlay of the MK3 condenser. */
	public static final ResourceLocation GUI_CONDENSER_MK3_OUTPUT = PECore.rl("textures/gui/condenser_mk3_output.png");
	/** Screen of the arcane transmutation tablet. */
	public static final ResourceLocation GUI_ARCANE_TABLET = PECore.rl("textures/gui/arcane_transmutation_tablet.png");
	/** Slot layout overlay of the arcane transmutation tablet. */
	public static final ResourceLocation GUI_ARCANE_TABLET_LAYOUT = PECore.rl("textures/gui/arcane_transmutation_tablet_layout.png");

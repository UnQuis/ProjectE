...
public class AdvancedAlchemicalChest {
	...
	public static void register() {
		for (DyeColor color : DyeColor.values()) {
			blocks.put(color, ExpansionBlocks.BLOCKS.register(String.format("%s_advanced_alchemical_chest", color.getName()), properties -> new BlockAdvancedAlchemicalChest(BlockAdvancedAlchemicalChest.getProperties(properties), color), (block, itemProperties) -> PEBlockItem.of(block, itemProperties)));
		}
	}
